...
public abstract class SwipeItem extends ItemTouchHelper.SimpleCallback {
    ...
    private Queue<Integer> removeQuere;
    ...
    private synchronized void recoverSwipedItem() {
        while (!removeQuere.isEmpty()){
            int pos = removeQuere.poll();
            if (pos > -1){
    ...
    public SwipeItem(Context context, RecyclerView recyclerView, int buttonWidth) {
        ...
        removeQuere = new LinkedList<Integer>(){
            @Override
